...
**DiscoveryOS turns server-side folders into AI-native workspaces where you can chat over your own files, study papers, and run experiments — all in one place.**
...
<p align="center">
  <img src="public/discoveryos-flow.png" alt="DiscoveryOS Workflow" width="800" />
</p>
...
> **Security**: DiscoveryOS includes shell execution and remote job submission capabilities. See [SECURITY.md](SECURITY.md) for deployment hardening and trust boundary documentation.
...
- `npx drizzle-kit migrate` creates or upgrades the SQLite schema at `./data/discoveryos.db`
...
```bash
git clone https://github.com/InternScience/DiscoveryOS.git && cd DiscoveryOS
...
DiscoveryOS supports three primary workflows. Pick the one that matches what you need today — you can always explore the others later.
...
- **Node.js Runtime Update**: DiscoveryOS now targets Node.js 24+ and is verified against both Node.js 24 LTS and the latest Node.js 25 current release. CI and local version hints have been updated accordingly.
...
- **Need setup or usage help?** Start with the [docs](https://InternScience.github.io/DiscoveryOS/)
- **Found a bug or want a feature?** [Open an issue](https://github.com/InternScience/DiscoveryOS/issues)
