export const PROVIDERS = {
  ...
  shlab: {
    ...
    name: "SH-Lab",
    models: [
      { id: "intern-s1-pro", name: "Intern S1 Pro", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "intern-s1", name: "Intern S1", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "qwen3.5-397b", name: "Qwen 3.5 397B", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "kimi-k2.5", name: "Kimi K2.5", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "deepseek-v3.2", name: "DeepSeek V3.2", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "minimax2.5", name: "MiniMax 2.5", contextWindow: 200000, baseUrl: "https://your-host/v1" },
      { id: "glm-5", name: "GLM-5", contextWindow: 200000, baseUrl: "https://your-host/v1" },
    ],
