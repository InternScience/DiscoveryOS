...
<p align="center">
  <a href="https://InternScience.github.io/DiscoveryOS/">ドキュメント</a> · <a href="#ja-quick-start">クイックスタート</a> · <a href="#ja-community-support">コミュニティ</a>
</p>

> この翻訳ページは英語版ホームページ `../README.md` より更新が遅れる場合があります。最新の `What's New` は英語版と中国語版が最も確実です。

DiscoveryOS はサーバー上のフォルダを、文書に根ざした対話、論文読解、科学ワークフロー、研究実行のための AI ネイティブなワークスペースに変えます。
...
- **リポジトリ** - https://github.com/InternScience/DiscoveryOS
