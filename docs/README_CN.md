...
<p align="center">
  <a href="https://InternScience.github.io/DiscoveryOS/">完整文档</a> · <a href="#cn-quick-start">安装与使用</a> · <a href="#cn-community-support">社区交流</a>
</p>

> 此翻译页可能会略晚于英文主页 `README.md` 更新。

DiscoveryOS 将服务器文件夹变成 AI 原生工作空间，用于基于文档的问答、论文研读、科学工作流和研究执行。
...
#### 2026-03-26
- **Node.js 运行时更新**: DiscoveryOS 现以 Node.js 24+ 为目标运行时，并已验证兼容 Node.js 24 LTS 与最新的 Node.js 25 Current 版本。CI 与本地版本提示也已同步更新。
...
DiscoveryOS 是一个面向研究工作的可自托管 Web 应用，把工作空间管理、RAG 对话、论文搜索与评审、可复用科学技能，以及 Agent 执行能力整合到同一个产品中。
...
DiscoveryOS 需要 Node.js 24+，以 `package.json` 中的要求为准。
...
- `npx drizzle-kit migrate` 会初始化或升级默认位于 `./data/discoveryos.db` 的 SQLite 数据库
...
3. 点击 `Sync`，让 DiscoveryOS 为当前工作空间建立 RAG 索引
...
- **想查看安装、使用和部署说明？** 先看完整文档：https://InternScience.github.io/DiscoveryOS/
- **想反馈 Bug 或提出功能建议？** 访问 GitHub Issues：https://github.com/InternScience/DiscoveryOS/issues
- **想直接交流？** 可加入下方飞书体验群

<img src="../site/social/飞书体验群.png" alt="DiscoveryOS 飞书体验群" width="200" />
...
- **仓库地址** - https://github.com/InternScience/DiscoveryOS
- **文档站点** - https://InternScience.github.io/DiscoveryOS/
