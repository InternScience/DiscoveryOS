...
This guide walks you through setting up DiscoveryOS locally for development or self-hosting.
...
This creates the database file at `./data/discoveryos.db` with all required tables.
...
Open your browser and navigate to **http://localhost:3000** to start using DiscoveryOS.
