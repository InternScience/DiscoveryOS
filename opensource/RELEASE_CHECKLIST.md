...
- [x] 确定新仓库名称和 GitHub 组织 → `InternScience/DiscoveryOS`
...
- [x] 创建 git tag `v0.1.0`
- [x] 创建 GitHub Release（v0.1.0）→ https://github.com/InternScience/DiscoveryOS/releases/tag/v0.1.0
...
- [x] 创建新 GitHub 仓库 → https://github.com/InternScience/DiscoveryOS
- [x] 推送代码（含完整 git 历史）
