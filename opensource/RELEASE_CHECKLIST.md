...
- [x] 确定新仓库名称和 GitHub 组织 → `SpectrAI-Initiative/InnoClaw`
...
- [x] 创建 git tag `v0.1.0`
- [x] 创建 GitHub Release（v0.1.0）→ https://github.com/SpectrAI-Initiative/InnoClaw/releases/tag/v0.1.0
...
- [x] 创建新 GitHub 仓库 → https://github.com/SpectrAI-Initiative/InnoClaw
- [x] 推送代码（含完整 git 历史）
